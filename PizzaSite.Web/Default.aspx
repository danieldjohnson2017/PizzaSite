<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="PizzaSite.Web.Default" %>
...
<body>
    ...
    <div class="container">
        ...
        <h1>Pizza Site's Pizza Shop</h1>
        <p class="lead">Pizza to fall in love with</p>
            </div>
        ...
        <div class="checkbox"><label><asp:CheckBox ID="greenPeppersCheckBox" runat="server" AutoPostBack="true" OnCheckedChanged="recalculateTotalCost"/> Green Peppers </label>
